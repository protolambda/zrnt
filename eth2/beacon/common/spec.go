...
type AltairConfig struct {
	...
	ALTAIR_INACTIVITY_PENALTY_QUOTIENT      uint64 `yaml:"ALTAIR_INACTIVITY_PENALTY_QUOTIENT" json:"ALTAIR_INACTIVITY_PENALTY_QUOTIENT"`
	ALTAIR_MIN_SLASHING_PENALTY_QUOTIENT    uint64 `yaml:"ALTAIR_MIN_SLASHING_PENALTY_QUOTIENT" json:"ALTAIR_MIN_SLASHING_PENALTY_QUOTIENT"`
	ALTAIR_PROPORTIONAL_SLASHING_MULTIPLIER uint64 `yaml:"ALTAIR_PROPORTIONAL_SLASHING_MULTIPLIER" json:"ALTAIR_PROPORTIONAL_SLASHING_MULTIPLIER"`
