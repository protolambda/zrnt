...
func ProcessDeposit(state *beacon.BeaconState, dep *beacon.Deposit) error {
	...
	if val_index == beacon.ValidatorIndexMarker {
		// Not a known pubkey, add new validator
		validator := beacon.Validator{
			Pubkey:                 pubkey,
			Withdrawal_credentials: withdrawalCredentials,
			Activation_epoch:       beacon.FAR_FUTURE_EPOCH, Exit_epoch: beacon.FAR_FUTURE_EPOCH, Withdrawable_epoch: beacon.FAR_FUTURE_EPOCH,
