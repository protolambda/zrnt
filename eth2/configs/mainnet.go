...
var Mainnet = &beacon.Spec{
	...
	Phase0Config: beacon.Phase0Config{
		...
		MIN_GENESIS_ACTIVE_VALIDATOR_COUNT:    0x4000,
		...
		EPOCHS_PER_HISTORICAL_VECTOR:          0x10000,
	...
	Phase1Config: beacon.Phase1Config{
		...
		EARLY_DERIVED_SECRET_PENALTY_MAX_FUTURE_EPOCHS:   0x8000,
		EPOCHS_PER_CUSTODY_PERIOD:                        0x4000,
		CUSTODY_PERIOD_TO_RANDAO_PADDING:                 2048,
		MAX_CHUNK_CHALLENGE_DELAY:                        0x8000,
