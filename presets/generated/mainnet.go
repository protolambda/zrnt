...
const MIN_ATTESTATION_INCLUSION_DELAY = 4
...
const LATEST_RANDAO_MIXES_LENGTH = 8192

const LATEST_ACTIVE_INDEX_ROOTS_LENGTH = 8192

const LATEST_SLASHED_EXIT_LENGTH = 8192
