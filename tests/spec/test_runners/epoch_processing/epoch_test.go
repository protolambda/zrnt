...
type stateFn func(spec *common.Spec, state *phase0.BeaconStateView, epc *phase0.EpochsContext, process *phase0.EpochProcess) error
...
func NewEpochTest(fn stateFn) test_util.TransitionCaseMaker {
	return func() test_util.TransitionTest {
		return &EpochTest{fn: func(spec *common.Spec, state *phase0.BeaconStateView, epc *phase0.EpochsContext, process *phase0.EpochProcess) error {
...
func TestFinalUpdates(t *testing.T) {
	test_util.RunTransitionTest(t, "epoch_processing", "final_updates",
		NewEpochTest(func(spec *common.Spec, state *phase0.BeaconStateView, epc *phase0.EpochsContext, process *phase0.EpochProcess) error {
